...
#define SCH_open_time 1
#define stop_time 2500
#define threshold_1 1
#define threshold_2 1
#define threshold_3 1
#define threshold_4 1
...
WaveNetDeviceExample::report(void)
{
	...
	std::cout <<"send_num_1="<<send_num_1<<",receive_num_1="<<receive_num_1<<",average_delay_1="<<average_delay_1<<"s"<<std::endl;
	std::cout <<"send_num_2="<<send_num_2<<",receive_num_2="<<receive_num_2<<",average_delay_2="<<average_delay_2<<"s"<<std::endl;
	std::cout <<"send_num_3="<<send_num_3<<",receive_num_3="<<receive_num_3<<",average_delay_3="<<average_delay_3<<"s"<<std::endl;
	std::cout <<"send_num_4="<<send_num_4<<",receive_num_4="<<receive_num_4<<",average_delay_4="<<average_delay_4<<"s"<<std::endl;
}
			...
			if (Queuelength(SPMA_QUEUE_1[i])>0)
			{
				if (channel_occupancy<threshold_1)
				{
					...
					packet_info test=SPMA_QUEUE_1[i].data[SPMA_QUEUE_1[i].front];
						...
						uint32_t channel_id=random(1,6);
