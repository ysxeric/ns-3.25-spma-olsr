...
//  void random_add_data_4();
  ...
  double time_transform(double time);

};

double
WaveNetDeviceExample::time_transform(double time)
{
	return time/2000;
}
...
WaveNetDeviceExample::report(void)
{
	...
	for(int i=1; i<5; i++){
		std::cout<<"collision_"<<i<<" num:"<<collision_pri[i]<<std::endl;
	}

	std::cout <<"send_num="<<send_num<<",receive_num="<<receive_num<<",average_delay="<<time_transform(average_delay)<<"s"<<std::endl;
	std::cout <<"send_num_1="<<send_num_1<<",receive_num_1="<<receive_num_1<<",pdr:"<<
			double(receive_num_1)/double(send_num_1*(node_number-1))<<",average_delay_1="<<time_transform(average_delay_1)<<"s"<<std::endl;
	std::cout <<"send_num_2="<<send_num_2<<",receive_num_2="<<receive_num_2<<",pdr:"<<
			double(receive_num_2)/double(send_num_2)<<",average_delay_2="<<time_transform(average_delay_2)<<"s"<<std::endl;
	std::cout <<"send_num_3="<<send_num_3<<",receive_num_3="<<receive_num_3<<",pdr:"<<
			double(receive_num_3)/double(send_num_3)<<",average_delay_3="<<time_transform(average_delay_3)<<"s"<<std::endl;
	std::cout <<"send_num_4="<<send_num_4<<",receive_num_4="<<receive_num_4<<",pdr:"<<
			double(receive_num_4)/double(send_num_4)<<",average_delay_4="<<time_transform(average_delay_4)<<"s"<<std::endl;
}
