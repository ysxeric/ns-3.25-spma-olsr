...
public:
  ...
  uint32_t Pktsovhd()
     ...
     void YRecvOlsr (Ptr< Packet> receivedPacket, Ipv4Address src);
...
private:
  ...
  virtual bool RouteInput (Ptr<const Packet> p,
                           ...
                           ErrorCallback ecb);
public:
  Ipv4Address YRouteOutput(Ipv4Address mip,Ipv4Address dst);
  Ipv4Address YRouteInput(Ipv4Address dst,Ptr<const NetDevice> idev);
private:
...
public:
  ...
  Callback<void,Ptr<Packet> , Ipv4Address , Ipv4Address> sendcallback;
